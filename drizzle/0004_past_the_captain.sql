...
ALTER TABLE "restaurants" ADD COLUMN "redes_sociales" text;--> statement-breakpoint
ALTER TABLE "categories" ADD CONSTRAINT "categories_restaurant_id_order_unique" UNIQUE("restaurant_id","order");